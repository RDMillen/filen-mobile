export const sv: {
    ...
    photos: "Foton",
    favorites: "Favoriter",
    offlineFiles: "Off-line",
    searchInThisFolder: "Sök i den här mappen",
    items: "Föremål",
    createFolder: "Skapa mapp",
    createTextFile: "Skapa textfil",of
    takePhotoAndUpload: "Ta ett foto och ladda upp",
    uploadFromGallery: "Ladda upp från galleriet",
    uploadFiles: "Ladda upp filer",
    selectAll: "Välj allas",
    ...
    cancel: "Avbryt",
    rename: "Döp om",
    invalidFolderName: "Ogiltigt mappnamn",
    alreadyExistsInThisFolder: "__NAME__ finns redan i den här mappen",
    folderRenamed: "Mappen har bytt namn",
    invalidFileName: "Ogiltigt filnamn",
    fileRenamed: "Fil bytt namn",
    folderName: "Mapp namn",
    create: "Skapa",
    folderCreated: "__NAME__ skapas",
    settingsHeaderUsage: "__USAGE__ av __MAX__ använda (__PERCENT__%)",
    darkMode: "Mörkt läge",
    language: "Språk",
    cameraUpload: "Uppladdning av kamera",
    upload: "Ladda upp",
    cannotMoveFileHere: "Det går inte att flytta filen hit",
    moveSameParentFolder: "Välj en annan mapp",
    itemMoved: "__NAME__ rörd",
    alreadyDownloadingFile: "Du laddar redan ned __NAME__",
    couldNotGetDownloadPath: "Det gick inte att hämta nedladdningsvägen",
    fileDownloaded: "__NAME__ nedladdade",
    onlyWifiUploads: "Använd endast Wi-Fi för uppladdningar",
    onlyWifiDownloads: "Använd endast Wi-Fi för nedladdningar",
    hideThumbnails: "Dölj miniatyrer",
    hideFileNames: "Dölj filnamn",
    biometricPinAuth: "Biometrisk/PIN koda autentisering",
    advanced: "Avancerad",
    itemSavedToGallery: "__NAME__ sparat i galleriet",
    noPermissionsToWriteToStorage: "Appen har inga behörigheter att skriva till lagringen",
    color_default: "Standar",
    color_blue: "Blå",
    color_green: "Grön",
    color_purple: "Lila",
    color_red: "Röd",
    color_gray: "Grå",
    folderColorChanged: "Färg på __NAME__ ändrad till __COLOR__",
    itemUnfavorited: "__NAME__ borttagen från favoriter",
    itemFavorited: "__NAME__ tillagd från favoriter",
    favorite: "Lägg till i favoriter",
    unfavorite: "Borttagen från favoriter",
    deviceOffline: "Enheten är offline",
    publicLinkEnabled: "Offentlig länk aktiverad",
    copy: "Kopiera",
    copiedToClipboard: "Kopierade till urklipp",
    publicLinkDownloadBtnEnabled: "Nedladdningsknappen är aktiverad",
    publicLinkExpiresNever: "Går aldrig ut",
    publicLinkExpiresHour: "Går ut om __NUM__ timme",
    publicLinkExpiresHours: "Går ut om __NUM__ timmar",
    publicLinkExpiresDay: "Går ut om __NUM__ dag",
    publicLinkExpiresDays: "Expires in __NUM__ dagar",
    save: "Spara",
    publicLinkPassword: "Länklösenord",
    remove: "Avlägsna",
    folderPublicLinkProgress: "__DONE__ av __TOTAL__ artiklar tillagda..",
    sharePlaceholder: "E-post från Filen-användare att dela med",
    shareUserNotFound: "Användaren hittades inte eller inte registrerad på Filen",
    sharedWithSuccess: "Objektet delas med __EMAIL__",
    moveItem: "Välj en mapp för __NAME__",
    itemTrashed: "__NAME__ flyttats till papperskorgen",
    itemRestored: "__NAME__ återställd från papperskorgen",
    alreadyExistsAtRestoreDestination: "__NAME__ finns redan och återställningsdestinationen",
    restore: "Återställ",
    deletePermanently: "Ta bort permanent",
    itemDeletedPermanently: "__NAME__ objekt raderas permanent",
    itemDeletedPermanentlyConfirmation: "Är du säker på att du vill ta bort objektet __NAME__ permanent? Denna åtgärd kan inte ångras!",
    sharedIn: "Delad",
    sharedOut: "Delning",
    loadingItemList: "Laddar...",
    publicLinks: "Länkar",
    stopSharing: "Sluta dela",
    stopSharingConfirmation: "Är du säker på att du vill sluta dela __NAME__? Den andra parten kommer inte längre att kunna komma åt det delade objektet!",
    removeFromSharedIn: "Ta bort",
    removeFromSharedInConfirmation: "Är du säker på att du vill ta bort __NAME__? Den andra personen kommer inte längre att kunna komma åt det delade objektet!",
    stoppedSharingItem: "Slutade dela __NAME__",
    removedFromSharedIn: "Tog bort __NAME__",
    events: "Händelse",
    fileUploaded: "__NAME__ uppladdad",
    photo: "Foto",
    currentVersion: "Aktuell version",
    noFileVersionsFound: "Inga filversioner hittades",
    preview: "Förhandsvisning",
    delete: "Radera",
    fileStoredOffline: "__NAME__ är nu tillgänglig off-line",
    removeFromOfflineStorage: "Ta bort från offlinelagring",
