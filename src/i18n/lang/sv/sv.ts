export const sv: {
    ...
    stopSharingConfirmation: "Är du säker på att du vill sluta dela __NAME__? The other party will no longer be able to access the shared item!",
    removeFromSharedIn: "Remove",
    removeFromSharedInConfirmation: "Are you sure you want to remove __NAME__? Den andra personen kommer inte längre att kunna komma åt det delade objektet!",
